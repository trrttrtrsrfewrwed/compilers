...
private:
  ...
  public:
    explicit TypeResolver(IrtreeBuildVisitor* main);
    void Visit(BinaryOperator *visited) override;
    void Visit(ClassDeclaration *visited) override;
    void Visit(ClassDeclarationList *visited) override;
    void Visit(CommonDeclaration *visited) override;
  ...
  private:
    IrtreeBuildVisitor* main_;
    std::string int_ = "int";
    std::string boolean_ = "boolean";
    std::string void_ = "void";
  };

  TypeResolver resolver_ = TypeResolver(this);
};